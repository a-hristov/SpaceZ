...
public class FrameZ extends JFrame {
   ...
   */
  public FrameZ(String titel, Container content, boolean resizable) {
    super(titel);
    this.add(content);
   ...
   * @param content Der im Fenster angezeigte Inhalt
   */
  public FrameZ(String titel, Container content) {
   ...
   */
  public FrameZ(String titel, Container content, boolean resizable, int width, int height) {
   ...
   * @param height Die Höhe des Fensters
   */
  public FrameZ(String titel, Container content, int width, int height) {
